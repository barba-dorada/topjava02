...
public class JdbcUserMealRepositoryImpl implements UserMealRepository {
    ...
    public List<UserMeal> getAll(int userId) {
        ...
        return jdbcTemplate.query("SELECT * FROM meals WHERE user_id=? ORDER BY date_time DESC", this::mapUserMeal, userId);
    }
    ...
    public List<UserMeal> getBetween(LocalDateTime startDate, LocalDateTime endDate, int userId) {
        ...
        return jdbcTemplate.query("SELECT * FROM meals WHERE user_id=? AND( date_time>=?) AND (date_time<?) ORDER BY date_time DESC", this::mapUserMeal, userId,
